import { IonContent,IonList,IonItem,   IonToolbar, IonGrid, IonRow ,IonCol} from "@ionic/react";
...
const ListaBarcode = () =>{
    const { user } = useAuth();
    const [codigos,setCodigos] = useState<{  codigo: string,beneficiado:string,fecha:string }[]>([]);
    ...
    const getCodigos = async ()=>{
        ...
        let url = "https://187.188.16.29:4431/webservice-app2/controllers/listarTarjetaRegalo.php";
          await  fetch(url, {
                method: 'POST', // or 'PUT'
