  ...
  const actualizarDatos = async () => {
    if (user) {
      const data = {
        ...
        nombre: user.Nombre_Asociado,
        apellidos: user.Apellidos,
        correo: user.CorreoE,
        telefono: user.CorreoE,
      };

      let url =
        "https://187.188.16.29:4431/webservice-app2/controllers/actualizarDatosApp.php";
      await fetch(url, {
        method: "POST", // or 'PUT'
  ...
  const actualizarContrasena = async () => {
    if (nuevaContrasena1 != "") {
      if (nuevaContrasena1 == nuevaContrasena2) {
        ...
        let url =
          "https://187.188.16.29:4431/webservice-app2/controllers/actualizarContrasena.php";
        await fetch(url, {
          method: "POST", // or 'PUT'
          // data can be `string` or {object}!
          body: JSON.stringify(data),
        ...
        <IonGrid>
          ...
          <IonRow>
            <IonCol className="datosContacto">
              ...
              <IonInput name="apellidos" type="text" value={user?.Apellidos}  disabled/>
              <IonLabel>Correo</IonLabel>
              <IonInput name="email" type="email" value={user?.CorreoE} />
              <IonLabel>Telefono</IonLabel>
              <IonInput name="telefono" type="tel" value={user?.Telefono} />
            </IonCol>
          </IonRow>
          <IonRow>
          ...
          <IonRow>
            <IonCol id="actualizarContrasena">
              <IonButton onClick={() => setShowModalContrasena(true)}>
      ...
      <IonModal isOpen={showModalContrasena}>
        <div className="contraseña">
          ...
          <IonInput
            ...
            onIonInput={(e: any) => {
              setNuevaContrasena1(e.target.value);
            }}
          />
          ...
          <IonInput
            ...
            onIonInput={(e: any) => {
              setNuevaContrasena2(e.target.value);
            }}
          />
          <span id="alerta">{alerta}</span>
          <IonButton id="actualizarContrasena" onClick={actualizarContrasena}>
            Actualizar contraseña
          </IonButton>
          <IonButton
            id="cerrarModalContrasena"
