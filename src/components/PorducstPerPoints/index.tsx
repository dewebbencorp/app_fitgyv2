        ...
        <IonContent>
            <div className="pp-main-container">
                ...
                <div className='pp-title'>
                    ...
                    {isVisible ? <h3 className='isActive' onClick={() => setIsVisible(false)}>Lista de productos</h3> 
                    : <h3 className='isActive' onClick={() => setIsVisible(true)}>VER HISTORIAL</h3>}

                </div>


                {
                    isVisible ? <PchHistory user={user.Clav_Asociado} /> : <>
